...
dir.create(kGraph.path, showWarnings = FALSE)
dir.create(paste(kGraph.path, "CPU", sep="\\"), showWarnings = FALSE)
dir.create(paste(kGraph.path, "CPU", "Sobel", sep="\\"), showWarnings = FALSE)
dir.create(paste(kGraph.path, "CPU", "FFT", sep="\\"), showWarnings = FALSE)
dir.create(paste(kGraph.path, "GPU", sep="\\"), showWarnings = FALSE)
dir.create(paste(kGraph.path, "GPU", "Sobel", sep="\\"), showWarnings = FALSE)
dir.create(paste(kGraph.path, "GPU", "FFT", sep="\\"), showWarnings = FALSE)
